# 樹鏈剖分 (Heavy-Light Decomposition) (單元教材)

本單元 **「樹鏈剖分 (Heavy-Light Decomposition)」** 專屬客製化教材目前正在全力撰寫與校對中！
...
1. **掌握單元核心概念**：將樹分解為重鏈，使樹上路徑操作轉換為線性區間操作。配合線段樹，樹上路徑修改/查詢時間複雜度為 $O(\log^2 N)$。
