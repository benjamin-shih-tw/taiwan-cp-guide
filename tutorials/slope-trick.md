# 斜率技巧 (Slope Trick) (單元教材)

本單元 **「斜率技巧 (Slope Trick)」** 專屬客製化教材目前正在全力撰寫與校對中！
...
1. **掌握單元核心概念**：以分段線性函數（piecewise linear convex function）的斜率為單位進行 DP，用優先佇列維護函數形狀，解決一類最小化絕對值偏差的問題。
