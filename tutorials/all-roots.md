# 換根 DP (Rerooting / All-Roots DP) (單元教材)

本單元 **「換根 DP (Rerooting / All-Roots DP)」** 專屬客製化教材目前正在全力撰寫與校對中！
...
1. **掌握單元核心概念**：透過兩次 DFS（先求以某節點為根的答案，再「換根」推廣到所有節點），在 $O(N)$ 時間內計算每個節點作為根的 DP 答案。
