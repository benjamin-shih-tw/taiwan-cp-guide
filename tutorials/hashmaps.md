# 雜湊表與自訂雜湊 (Hashmaps & Custom Hashing) (單元教材)

本單元 **「雜湊表與自訂雜湊 (Hashmaps & Custom Hashing)」** 專屬客製化教材目前正在全力撰寫與校對中！
...
1. **掌握單元核心概念**：理解 `std::unordered_map` 的運作原理與常數優化，以及如何自訂 Hash 函數防止刻意構造的 worst case，在競程中做到穩定 $O(1)$。
