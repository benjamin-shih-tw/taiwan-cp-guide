# 網路最大流 (Maximum Flow / Dinic's Algorithm) (單元教材)

本單元 **「網路最大流 (Maximum Flow / Dinic's Algorithm)」** 專屬客製化教材目前正在全力撰寫與校對中！
...
1. **掌握單元核心概念**：求網路從源點到匯點的最大流量。Dinic 演算法（BFS 分層圖 + DFS 增廣路 + 當前弧優化）在 $O(V^2 E)$ 最壞、$O(E \sqrt{V})$ 二分圖場景下高效。
