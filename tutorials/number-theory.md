# 數論基礎 (Number Theory & Modular Arithmetic) (單元教材)

本單元 **「數論基礎 (Number Theory & Modular Arithmetic)」** 專屬客製化教材目前正在全力撰寫與校對中！
...
1. **掌握單元核心概念**：質數篩法（線性篩）、輾轉相除法、擴展 GCD（ExGCD）、費馬小定理與模逆元、以及整除分塊。模運算在計數 DP 中無所不在。
