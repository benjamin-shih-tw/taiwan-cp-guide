# 線段樹進階：合併、持久化、可持久線段樹 (單元教材)

本單元 **「線段樹進階：合併、持久化、可持久線段樹」** 專屬客製化教材目前正在全力撰寫與校對中！
...
1. **掌握單元核心概念**：線段樹合併（Segment Tree Merging）用於樹上操作；主席樹（Persistent Segment Tree / 可持久化線段樹）支援歷史版本查詢，可解決靜態區間第 K 小。
