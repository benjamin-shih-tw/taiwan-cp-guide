# 自訂排序與貪心進階 (Sorting-based Greedy) (單元教材)

本單元 **「自訂排序與貪心進階 (Sorting-based Greedy)」** 專屬客製化教材目前正在全力撰寫與校對中！
...
1. **掌握單元核心概念**：設計特定的比較函式使資料排列後具備貪心選擇的最優性。包含區間排程、交換論證（Exchange Argument）等技巧。
