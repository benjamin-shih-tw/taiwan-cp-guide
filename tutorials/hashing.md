# 字串雜湊 (String Hashing) (單元教材)

本單元 **「字串雜湊 (String Hashing)」** 專屬客製化教材目前正在全力撰寫與校對中！
...
1. **掌握單元核心概念**：以多項式滾動雜湊（Polynomial Rolling Hash）在 $O(N)$ 預處理後，$O(1)$ 比較任意子字串是否相等。用於字串比對、回文偵測、LCP 計算。
