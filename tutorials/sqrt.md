# 根號算法與莫隊 (Sqrt Decomposition / Mo's Algorithm) (單元教材)

本單元 **「根號算法與莫隊 (Sqrt Decomposition / Mo's Algorithm)」** 專屬客製化教材目前正在全力撰寫與校對中！
...
1. **掌握單元核心概念**：將資料分成 $\sqrt{N}$ 塊分別處理；莫隊以 $O(N\sqrt{N})$ 離線回答無修改區間查詢。帶修莫隊、樹上莫隊等進階變體。
