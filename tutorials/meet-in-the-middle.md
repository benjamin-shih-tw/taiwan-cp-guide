# 分治折半搜索 (Meet in the Middle) (單元教材)

本單元 **「分治折半搜索 (Meet in the Middle)」** 專屬客製化教材目前正在全力撰寫與校對中！
...
1. **掌握單元核心概念**：對長度為 N 的問題，分成兩個長度為 N/2 的子問題分別枚舉，再合併結果，將 $O(2^N)$ 降至 $O(2^{N/2} \log N)$。
